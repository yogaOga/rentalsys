...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="input">
		<?php echo $form->labelEx($model,'nmtunjangan'); ?>
		<?php echo $form->textField($model,'nmtunjangan'); ?>
		<span class="error-message"><?php echo $form->error($model,'nmtunjangan'); ?></span>
	</div>
	...
	<div class="input">
		...
		<span class="error-message"><?php echo $form->error($model,'status'); ?></span>
	</div>
