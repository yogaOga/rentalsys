...
$modelFEdu = new HFormalEduApplicant($criteria);
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'deleteButtonUrl' => 'Yii::app()->createUrl("hrd/mApplicant/removeFEdu", array("id"=>$data->id))',
            'buttons' => array(
                'update' => array(
                    'label' => 'Update',
                    'options' => array('style' => 'cursor:pointer'),
                    'url' => 'Yii::app()->createUrl("hrd/mApplicant/getFEdu", array("id"=>$data->id))',
...
$criteria = new CDbCriteria();
$criteria->condition = 'applicant_id = ' . $model->id;
$modelIEdu = new HInformalEduApplicant($criteria);
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'class' => 'CButtonColumn',
            'template' => '{update}{delete}',
            'deleteButtonUrl' => 'Yii::app()->createUrl("hrd/mApplicant/removeIEdu", array("id"=>$data->id))',
            'buttons' => array(
                'update' => array(
                    'label' => 'Update',
                    'options' => array('style' => 'cursor:pointer'),
                    'url' => 'Yii::app()->createUrl("hrd/mApplicant/getIEdu", array("id"=>$data->id))',
...
$criteria = new CDbCriteria();
$criteria->condition = 'applicant_id = ' . $model->id;
$modelLangApp = new HLanguageApplicant($criteria);
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'class' => 'CButtonColumn',
            'template' => '{update}{delete}',
            'deleteButtonUrl' => 'Yii::app()->createUrl("hrd/mApplicant/removeLang", array("id"=>$data->id))',
            'buttons' => array(
                'update' => array(
                    'label' => 'Update',
                    'options' => array('style' => 'cursor:pointer'),
                    'url' => 'Yii::app()->createUrl("hrd/mApplicant/getLang", array("id"=>$data->id))',
    ...
    <div class="bloc">
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'majoring_a',
                'source' => $this->createUrl('MApplicant/GetMajoringEducation'),
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'school_name_a',
                'source' => $this->createUrl('MApplicant/GetSchoolNameEducation'),
                // additional javascript options for the autocomplete plugin
                'options' => array(
                    'showAnim' => 'fold',
                    'minLength' => 2,
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'city_country_a',
                'source' => $this->createUrl('MApplicant/GetCityCountryEducation'),
                // additional javascript options for the autocomplete plugin
                'options' => array(
                    'showAnim' => 'fold',
                    'minLength' => 2,
...
<div id="dialog">
    <div class="bloc">
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'course_name_ia',
                'source' => $this->createUrl('MApplicant/GetCourseNameIEducation'),
                // additional javascript options for the autocomplete plugin
                'options' => array(
                    'showAnim' => 'fold',
                    'minLength' => 2,
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'level_ia',
                'source' => $this->createUrl('MApplicant/GetLevelIEducation'),
                // additional javascript options for the autocomplete plugin
                'options' => array(
                    'showAnim' => 'fold',
                    'minLength' => 2,
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                ...
                'source' => $this->createUrl('MApplicant/GetCityCountryIEducation'),
                // additional javascript options for the autocomplete plugin
                'options' => array(
                    'showAnim' => 'fold',
                    'minLength' => 2,
        ...
        <div class="input">
           ...
           <?php
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                ...
                'source' => $this->createUrl('MApplicant/GetLangName'),
                // additional javascript options for the autocomplete plugin
                'options' => array(
                    'showAnim' => 'fold',
                    'minLength' => 2,
