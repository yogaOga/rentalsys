...
<div class="left">
    ...
    <div class="input">
        ...
        <?php echo $form->textField($model, 'birth_date', array('size' => 25, 'maxlength' => 25, 'class' => 'datepicker', 'placeholder' => '01-01-2014')); ?>
    ...
    <div class="input">
        ...
        <?php echo $form->dropDownlist($model, 'city_id', CHtml::listData(MCity::model()->findAll(), 'id', 'city_name'), array('empty' => '- Select')) ?>
    ...
    <div class="input">
        ...
        <?php echo $form->textField($model, 'phone', array('size' => 25, 'maxlength' => 25, 'placeholder' => '(021)-2345678')); ?>
        <span class="error-message"><?php echo $form->error($model, 'phone'); ?></span>
    </div>
    <div class="input">
        <?php echo $form->labelEx($model, 'mobile'); ?>
        <?php echo $form->textField($model, 'mobile', array('size' => 25, 'maxlength' => 25, 'placeholder' => '0812-34567890')); ?>
    ...
    <div class="input">
        ...
        <ul class="gallery">
            <li style="width: 140px; height: 160px;">
                <a style="width: 100%; height: 100%;" href="#"><img style="width: 100%; height: 100%;" src="<?php if(isset($model->photo_path)){echo Yii::app()->getBaseUrl().'/'.$model->photo_path;}else{echo Yii::app()->getBaseUrl().'/img/blank.png';}?>" alt=""/></a>
                <span class="info"></span>
                <a href="#" title="delete Image" class="del">Delete</a>
                <a href="#" class="over"><span><?php echo $form->fileField($model, 'photo_path'); ?></span></a>
                <a href="<?php if(isset($model->photo_path)){echo Yii::app()->getBaseUrl().'/'.$model->photo_path;}else{echo Yii::app()->getBaseUrl().'/img/blank.png';}?>" class="large zoombox" title="full-size">Enlarge</a>
            </li>
        </ul>
