...
<div class="left">
    <div class="input">
        <?php echo $form->labelEx($model, 'applicant_no'); ?>
        <?php echo $form->textField($model, 'applicant_no', array('size' => 25, 'maxlength' => 25, 'placeholder' => 'Applicant ID')); ?>
        <span class="error-message"><?php echo $form->error($model, 'applicant_no'); ?></span>
    </div>
    <div class="input">
        <?php echo $form->labelEx($model, 'nip'); ?>
        <?php echo $form->textField($model, 'nip', array('size' => 25, 'maxlength' => 25, 'placeholder' => 'Applicant ID')); ?>
