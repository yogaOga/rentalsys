...
$('#memployee-grid').yiiGridView('update', {
data: $(this).serialize()
});
return false;
});
...
<h1><img src="/rentalsys/img/icons/dashboard.png" alt="" /> Manage Memployees</h1>
...
<div class="bloc">
    <div class="title">Table Memployees</div> 
    <div class="content">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    'name' => 'applicant.applicant_no',
                    'type' => 'raw',
                    'value' => 'CHtml::link($data->applicant->applicant_no, array("MApplicant/Update&id=".$data->applicant->id) , array())',
                    'htmlOptions' => array(
                        'style' => 'width:60px;',
                    ),
                    'filter' => CHtml::activeTextField($model, 'applicant_no'),
                ),
                'first_name',
                'last_name',
                'nickname',
