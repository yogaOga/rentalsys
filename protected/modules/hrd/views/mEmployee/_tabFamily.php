...
$modelFam = new HFamilyEmployee($criteria);
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'deleteButtonUrl' => 'Yii::app()->createUrl("hrd/MEmployee/removeFamily", array("id"=>$data->id))',
            'buttons' => array(
                'update' => array(
                    'label' => 'Update',
                    'options' => array('style' => 'cursor:pointer'),
                    'url' => 'Yii::app()->createUrl("hrd/MEmployee/getFamily", array("id"=>$data->id))',
    ...
    <div class="bloc">
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'place_birth_a',
                'source' => $this->createUrl('MEmployee/GetBirthPlaceFamily'),
