...
$modelOcup = new HOccupationEmployee($criteria);
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'deleteButtonUrl' => 'Yii::app()->createUrl("hrd/mEmployee/removeOccupation", array("id"=>$data->id))',
            'buttons' => array(
                'update' => array(
                    'label' => 'Update',
                    'options' => array('style' => 'cursor:pointer'),
                    'url' => 'Yii::app()->createUrl("hrd/mEMployee/getOccupation", array("id"=>$data->id))',
    ...
    <div class="bloc">
        ...
        <div class="input">
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'company_name_a',
                'source' => $this->createUrl('mEmployee/GetCompanyOccupation'),
