...
/**
 * This is the model class for table "h_language_applicant".
 *
 * The followings are the available columns in table 'h_language_applicant':
 * @property integer $id
 ...
 */
//class HLanguageApplicant extends CActiveRecord
class HLanguageApplicant extends BaseModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('applicant_id, language_name, speaking, writing', 'required'),
			...
			array('id, applicant_id, language_name, speaking, writing', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return HLanguageApplicant the static model class
	 */
