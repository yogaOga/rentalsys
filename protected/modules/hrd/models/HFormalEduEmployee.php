...
/**
 * This is the model class for table "h_formal_edu_employee".
 *
 * The followings are the available columns in table 'h_formal_edu_employee':
 * @property integer $id
 ...
 */
//class HFormalEduEmployee extends CActiveRecord
class HFormalEduEmployee extends BaseModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('employee_id, education_name, graduate_year, school_name, city_country, certificate_number', 'required'),
			...
			array('id, employee_id, education_name, graduate_year, majoring, school_name, city_country, certificate_number', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return HFormalEduEmployee the static model class
	 */
