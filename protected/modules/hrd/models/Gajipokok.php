...
/**
 * This is the model class for table "gajipokok".
 *
 * The followings are the available columns in table 'gajipokok':
 * @property integer $id
...
class Gajipokok extends BaseModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, tglawal, tglakhir, gajipokok, catatan', 'safe', 'on'=>'search'),
		);
	}
