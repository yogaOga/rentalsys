...
/**
 * This is the model class for table "m_car_rental".
 *
 * The followings are the available columns in table 'm_car_rental':
 * @property integer $id
 ...
 */
class MCarRental extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, no_cmd, mobil_id, unit, klas_driver, rental_rates, contract_periode', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MCarRental the static model class
	 */
