...
<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('l_business_type')); ?>:</b>
	<?php echo CHtml::encode($data->l_business_type); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('l_ownership')); ?>:</b>
	<?php echo CHtml::encode($data->l_ownership); ?>
	<br />
